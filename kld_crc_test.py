...
#sampP = pd.read_csv('~/matovanalysis/DELFI_analysis/python/delfi2_ctl1_74_1M.csv')
...
#sampQ = pd.read_csv('~/matovanalysis/DELFI_analysis/python/delfi2_col_all79.csv')
...
#sampQ = pd.read_csv('~/matovanalysis/DELFI_analysis/python/delfi2_col_all79_1M.csv')
...
#estP.to_csv('~/matovanalysis/DELFI_analysis/python/KLdivergenceD2_COL79_CTL1_1M.csv')
...
#estP.to_csv('~/matovanalysis/DELFI_analysis/python/KLdivergenceD2_COL79_ctl276.csv')
#estP.to_csv('~/matovanalysis/DELFI_analysis/python/KLdivergenceD2_CRC129_ctl1.csv')
